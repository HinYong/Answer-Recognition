    ...
    if file.endswith('JPG') or file.endswith('PNG') or file.endswith('png') or file.endswith('jpg'):
        ...
        if len(question_2) < question2_num:
            ...
            while count > 0:
                ...
                if question_1[len(question_1) - 1][2] - question_2[len(question_2) - 1][2] > question_2[len(question_2) - 1][4] * 0.4:
...
with open('src/main/webapp/downloadfile/score.csv', 'w', encoding='GBK', newline='') as f:
    writer = csv.writer(f)
