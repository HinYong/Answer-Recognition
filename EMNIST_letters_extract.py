...
# 提取训练集
# img_file = r'emnist\emnist-letters-train-images-idx3-ubyte\emnist-letters-train-images-idx3-ubyte'
# label_file = r'emnist\emnist-letters-train-labels-idx1-ubyte\emnist-letters-train-labels-idx1-ubyte'
# 提取测试集
img_file = r'emnist\emnist-letters-test-images-idx3-ubyte\emnist-letters-test-images-idx3-ubyte'
label_file = r'emnist\emnist-letters-test-labels-idx1-ubyte\emnist-letters-test-labels-idx1-ubyte'
generate_img_root = r"F:\emnist"  # 保存图片路径
