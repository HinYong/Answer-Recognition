...
choose_model = tf.keras.models.load_model('./model/model_abcd.h5')  # 加载模型
judge_model = tf.keras.models.load_model('./model/model_ft.h5')  # 加载模型
